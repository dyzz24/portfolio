...
export const Slider: React.FC<ISlider> = ({slides}) => {
    ...
    return <>
        <div className="slider_block">
            {slides.length > 1 && <div className="slider__control_left">
            ...
            <div className="slider_wrapper">
                {slides.map((el, idx) => <img alt={'slide'} loading={'lazy'} src={el} className="slid"/>)}

            </div>
            {slides.length > 1 && <div className="slider__control_right">
                <svg width="22" height="40" viewBox="0 0 22 40" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path className='anim_svg' fillRule="evenodd" clipRule="evenodd"
        ...
        {slides.length > 1 && <div className="slider__btn_block">
            {slides.map((el, idx) => <div className={'slider_btn'}/>)}
            {/*<div className="slider_btn active" data-count="0"></div>*/}
